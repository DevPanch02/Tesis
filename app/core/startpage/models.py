...
class Person(models.Model):
    ...
    RUC=models.CharField(max_length=13,default='', null=True, blank=True)
    nombrecomercial=models.CharField(max_length=50,default='', null=True, blank=True)
    ...
    valorpagar=models.CharField(max_length=20,default='', null=True, blank=True)
    ...
    descripcion=models.CharField(max_length=50,default='', null=True, blank=True)
